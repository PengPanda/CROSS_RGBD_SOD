...
class CROSS(nn.Module):
    ...
    def forward(self, x, xd):
        ...
        # pmap.append(prior5)
        # pmap.append(prior6)
        return  sal_out, edge_out, ed2,ed3,ed4,ed5, global_prior, local_prior
